...
from pydantic import BaseModel, Field   # Pydantic base model is just used to define any schema
...
all_todos = [
    ...
    Todo(todo_id=5, todo_name='Study', todo_description='Prepare for upcoming exam', priority=Priority.MEDIUM)
]
...
POST: Create/Submit something new to the server
PUT: When you change something in the server
DELETE: Delete something from the server 

"""


# Using path parameters: 'todos/{todo_id}'
...
def get_todo(todo_id: int):
 ...
 # Using query parameters: 'todos?first_n=x'       
